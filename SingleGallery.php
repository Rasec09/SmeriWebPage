       ...
       <div class="container">
           <center><h4>
                <?php 
                    ...
                    echo htmlspecialchars($nombreGaleria);
                ?>
            </h4></center>
            <div class="row g-pad-bottom">
                <div class="col-md-10 col-md-offset-1 col-sm-12">
                    <ul class="portfolio-items col-3">
                        ...
                        <!-- Gallery Item -->
                        <?php
                            $imageDirectory = 'Galerias/' . $nombreGaleria . '/'; // Ruta del directorio de imágenes
                                    ...
                                    <li class="portfolio-item">
                                        <div class="item-main">
                                            <div class="portfolio-image">
                                                ...
                                                <div class="overlay">
                                                    <a class="preview btn btn-danger" href="' . $imageDirectory . $file . '">
                                                    <i class="fa fa-eye">Ver imagen</i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </li>';   
